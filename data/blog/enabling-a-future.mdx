...
date: '2024-10-21'
tags: ['Restaking', 'Eigenlayer', 'Ethereum', 'Decentralization', 'Bitcoin']
draft: false
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
  <img src="/static/images/enabling-1.png" alt="Catalysis Network" />
  <em>Catalysis: A future of a thousand AVSs</em>
</div>

In the rapidly evolving world of decentralization, **shared security (or restaking)** has emerged as a powerful mechanism to bootstrap decentralized protocols and services. With [billions of dollars restaked](https://defillama.com/protocols/Restaking) across Shared Security Protocols demanding a return on their deposits, the critical question becomes: where does the yield come from? **AVSs are the answer.**
...
At [Catalysis](https://x.com/0xcatalysis), we believe we're at a critical juncture in the restaking ecosystem, requiring innovation around **AVS economics** and **developer experience** to ensure a sustainable future for the entire shared security space.
...
Right now, there are only a handful of AVSs that anchor this ecosystem. At the time of writing this blog, there are [19 AVSs](https://app.eigenlayer.xyz/avs) on the Eigenlayer dashboard. Symbiotic has also announced its first cohort of [14 AVSs](https://blog.symbiotic.fi/introducing-cohort-1/).
...
As [Shopify](https://www.shopify.com/in)'s founder, Tobi Lütke, [puts it](https://www.startuparchive.org/p/tobi-lutke-explains-what-the-vcs-who-passed-on-shopify-got-wrong):
...
AVS, or Actively Validated Service, is a term used to describe systems that require their own distributed validation mechanisms for verification. As explained by [Eigenlayer](https://docs.eigenlayer.xyz/eigenlayer/overview/key-terms), an AVS could be:
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/static/images/enabling-2.png" alt="AVS Ecosystem Growth" />
</div>
...
The good news? Hundreds of AVSs are in development and expected to launch in the coming months. Restaking protocols within the Babylon ecosystem, like [Satlayer](https://satlayer.xyz/) & [Pell Network](https://pell.network/), are also seeing strong interest. Experiments are underway at all levels to remove friction, and Catalysis is leading the charge.

## 5. Catalysis' Vision: A Future of Thousands of AVSs

At Catalysis, we envision a future where thousands of AVSs are seamlessly operating across multiple shared security protocols. These AVSs will power critical infrastructure across **decentralized AI (dAI), decentralized physical infrastructure networks (dePIN), zero-knowledge (ZK) applications,** [verifiable web2 SaaS](https://x.com/dabit3/status/1829153823673233735) and countless new use cases that crypto will unlock in the near future.
...
2. SSPs: [Eigenlayer](https://www.eigenlayer.xyz/), [Symbiotic](https://symbiotic.fi/), [Karak](https://www.karak.network/), [Nektar](https://nektar.network/), [Satlayer](https://satlayer.xyz/), [Pell](https://www.pell.network/), [Jito](https://www.jito.network/blog/announcing-jito-restaking/), [Picasso](https://www.picasso.network/), [Solayer](https://solayer.org/), [Avail Fusion](https://docs.availproject.org/docs/welcome-to-avail-docs)

3. LRTs: [Etherfi](https://www.ether.fi/), [Puffer](https://www.puffer.fi/), [Renzo](https://www.renzoprotocol.com/), [Kelp](https://kelpdao.xyz/), [Swell](https://www.swellnetwork.io/), [Bedrock](https://www.bedrock.technology/), [Level](https://www.level.money/)