...
draft: false
summary: "Institutional capital is ready to flow onchain, but without coverage infrastructure, it won't. Just as Lloyd's enabled global trade, DeFi needs institutional-scale coverage to unlock trillions."
---
...
<div style={{ display: 'flex', justifyContent: 'center', maxWidth: '750px', margin: '0 auto' }}>
  <img src="/static/images/coverage-ratio.png" alt="Coverage ratio" style={{ width: '100%', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', maxWidth: '750px', margin: '0 auto' }}>
  <img src="/static/images/competition-slide.jpg" alt="Competition" style={{ width: '100%', height: 'auto' }} />
</div>
