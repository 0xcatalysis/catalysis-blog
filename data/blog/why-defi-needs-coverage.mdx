...
<div style={{ display: 'flex', justifyContent: 'center', maxWidth: '750px', margin: '0 auto' }}>
  <img src="/static/images/coverage-ratio.png" alt="Catalysis Core v0" style={{ width: '100%', height: 'auto' }} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', maxWidth: '750px', margin: '0 auto' }}>
  <img src="/static/images/competition-slide.png" alt="Competition" style={{ width: '100%', height: 'auto' }} />
</div>
